...
// Dynamic ALL_STATES calculation will be inside the component
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function DashboardView({ useCasesData }) {
  ...
  }, [search, status, category, selectedStates, useCasesData])
      ...
      <main className="max-w-screen-xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">Complete list of all {useCasesData.length} registered use cases</p>
          </div>
                  ...
                  {stateDropOpen && (
                    <div style={{
                      ...
                      {ALL_STATES.map(state => {
                        ...
                        const count = useCasesData.filter(u => u.dept === state).length
                        return (
