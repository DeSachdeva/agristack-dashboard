...
const priorityData = [
  { name: 'High',   value: USE_CASES.filter(u => u.priority === 'High').length,   color: '#166340' },
  { name: 'Medium', value: USE_CASES.filter(u => u.priority === 'Medium').length, color: '#3aaa75' },
  { name: 'Low',    value: USE_CASES.filter(u => u.priority === 'Low').length,    color: '#a8dfc0' },
]
      ...
      <main className="max-w-screen-xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-3 gap-5 mb-7">
          ...
          <div className="bg-white rounded-xl border p-5" style={{ borderColor: '#e8f0e0' }}>
            <div className="text-sm font-medium mb-2" style={{ color: '#0e3d28' }}>By Priority</div>
